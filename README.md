...
current ```package-activated-list```:

    (ace-isearch helm-swoop helm helm-core async popup async avy ace-jump-mode ace-jump-buffer dash avy ace-jump-mode ace-window avy ag s dash ample-zen-theme anzu avy beacon seq browse-at-remote s f dash s browse-kill-ring cljr-helm helm helm-core async popup async clj-refactor hydra inflections edn peg cider seq spinner queue pkg-info epl clojure-mode multiple-cursors paredit yasnippet dash s coffee-mode color-theme company-web web-completion-data dash company crux darkburn-theme darktooth-theme dash-at-point diff-hl diminish discover-my-major makey dockerfile-mode easy-kill elisp-slime-nav erlang evalator-clojure evalator helm-core async cider seq spinner queue pkg-info epl clojure-mode exec-path-from-shell expand-region flx-ido flx flycheck seq let-alist pkg-info epl dash gist gh logito pcache git-blame git-gutter-fringe+ fringe-helper git-gutter+ dash git-commit with-editor dash async dash git-timemachine gitconfig-mode gitignore-mode god-mode golden-ratio grizzl gruvbox-theme guru-mode helm-bind-key helm helm-core async popup async bind-key helm-bm s helm helm-core async popup async bm helm-c-moccur color-moccur helm helm-core async popup async helm-clojuredocs helm helm-core async popup async edn peg helm-dash helm helm-core async popup async helm-dictionary helm helm-core async popup async helm-git-files helm helm-core async popup async helm-git-grep helm helm-core async popup async helm-projectile dash projectile pkg-info epl dash helm helm-core async popup async helm-projectile-all s dash projectile pkg-info epl dash helm helm-core async popup async helm-swoop helm helm-core async popup async highlight-indentation highlight-symbol hydra ido-ubiquitous ido-completing-read+ imenu-anywhere inf-ruby inflections js2-mode json-mode json-snatcher json-reformat json-reformat json-snatcher key-chord lcs less-css-mode let-alist logito lui tracking magit-gitflow magit-popup dash async magit magit-popup dash async git-commit with-editor dash async dash with-editor dash async dash async magit-popup dash async makey markdown-mode mellow-theme move-text multiple-cursors naquadah-theme operate-on-number ov paxedit paredit pcache peg popup powerline projectile pkg-info epl dash queue rainbow-delimiters rainbow-mode rake dash f dash s ruby-tools rvm s sass-mode haml-mode scss-mode seq shell-pop shorten smart-mode-line rich-minority smartparens dash smartrep smex spinner toggle-quotes tracking undo-tree vkill volatile-highlights w3m web-completion-data web-mode window-numbering with-editor dash async yaml-mode yari yasnippet zenburn-theme zop-to-char)
