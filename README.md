...
current ```package-activated-list```:
    ...
    (ace-isearch helm-swoop helm helm-core async async avy ace-jump-mode ace-jump-buffer dash ace-jump-mode ace-jump-mode ace-window avy ample-zen-theme anzu avy beacon seq browse-at-remote s f dash s browse-kill-ring cljr-helm helm helm-core async async clj-refactor hydra inflections edn s peg dash cider seq spinner queue pkg-info epl clojure-mode multiple-cursors paredit yasnippet dash s clojure-mode color-theme company darkburn-theme darktooth-theme dash-at-point diff-hl diminish discover-my-major makey dockerfile-mode easy-kill edn s peg dash elisp-slime-nav erlang exec-path-from-shell expand-region flx-ido flx flycheck seq let-alist pkg-info epl dash gist gh logito pcache git-gutter-fringe fringe-helper git-gutter git-timemachine gitconfig-mode gitignore-mode god-mode golden-ratio grizzl guru-mode helm-bm s helm helm-core async async bm helm-dash helm helm-core async async helm-git-files helm helm-core async async helm-git-grep helm helm-core async async helm-projectile dash projectile pkg-info epl dash helm helm-core async async helm-projectile-all s dash projectile pkg-info epl dash helm helm-core async async helm-swoop helm helm-core async async highlight-indentation highlight-symbol hydra ido-ubiquitous s ido-completing-read+ js2-mode json-mode json-snatcher json-reformat json-reformat json-snatcher lcs less-css-mode let-alist logito lui tracking magit-gitflow magit-popup dash async magit magit-popup dash async git-commit with-editor dash async dash with-editor dash async dash async magit-popup dash async makey markdown-mode mellow-theme move-text multiple-cursors naquadah-theme neotree operate-on-number ov paxedit paredit pcache peg powerline projectile-rails rake dash f dash s f dash s inf-ruby inflections projectile pkg-info epl dash queue rainbow-delimiters rainbow-mode rake dash f dash s ruby-tools rvm s scss-mode seq shell-pop shorten smart-mode-line rich-minority smartparens dash smartrep smex spinner toggle-quotes tracking undo-tree vkill volatile-highlights w3m web-mode window-numbering with-editor dash async yari yasnippet zenburn-theme zop-to-char)
