(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zop-to-char zenburn-theme zen-and-art-theme yari yaml-mode window-numbering which-key web-mode warm-night-theme waher-theme w3m volatile-highlights vkill vdiff undo-tree twilight-theme toggle-quotes tao-theme tangotango-theme tango-2-theme suscolors-theme subatomic256-theme stekene-theme soft-charcoal-theme smyx-theme smex smartrep smartparens smart-mode-line slime-theme slime-company shorten shell-pop scss-mode sass-mode rvm ruby-tools reykjavik-theme rake rainbow-mode rainbow-delimiters railscasts-theme purple-haze-theme powerline phoenix-dark-mono-theme paxedit ov operate-on-number move-text monokai-theme monochrome-theme mellow-theme markdown-mode magit-gitflow lui less-css-mode lcs key-chord json-mode js2-mode jazz-theme ivy inf-ruby imenu-anywhere ido-ubiquitous highlight-symbol highlight-indentation helm-projectile-all helm-projectile helm-hunks helm-git-grep helm-git-files helm-dictionary helm-dash helm-clojuredocs helm-cider-history helm-cider helm-chrome helm-c-moccur helm-bm helm-bind-key guru-mode gruvbox-theme gruber-darker-theme grizzl golden-ratio god-mode gitignore-mode github-search gitconfig-mode git-timemachine git-gutter-fringe+ git-blame gist focus flycheck flx-ido firecode-theme expand-region exec-path-from-shell erlang elisp-slime-nav easy-kill dockerfile-mode discover-my-major diminish diff-hl dash-at-point darktooth-theme darkburn-theme darcula-theme dakrone-theme crux company-web color-theme coffee-mode cljr-helm busybee-theme browse-kill-ring browse-at-remote beacon badwolf-theme badger-theme atom-one-dark-theme anzu ample-zen-theme alect-themes ag ace-window ace-jump-mode ace-jump-buffer)))
...
(custom-set-faces
 ...
 '(helm-source-header ((t (:background "#1d1d1d" :foreground "#888" :underline nil :weight normal))))
